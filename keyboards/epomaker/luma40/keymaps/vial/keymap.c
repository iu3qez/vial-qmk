...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_tkl_ansi(
        ...
        MO(2),   LT(1,KC_LCTL), KC_GRV, LT(3,KC_LGUI), KC_LALT,            KC_SPC,  KC_RALT, KC_SLSH, KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
    [1] = LAYOUT_tkl_ansi(
        KC_F1,   KC_F2,   KC_F3,     KC_F4,    KC_F5,      KC_F6,     KC_F7,    KC_F8,    KC_F9,   KC_F10,   KC_F11,        KC_F12,
        KC_CAPS, KC_A,    KC_S,      KC_D,     KC_F,       KC_G,      KC_H,     KC_J,     KC_KP_7, KC_KP_8,  KC_KP_9,       KC_ENT,
        KC_LSFT, KC_Z,    KC_X,      KC_C,     KC_V,       KC_B,      KC_N,     KC_M,     KC_KP_4, KC_KP_5,  KC_KP_6,       KC_KP_COMMA,
        MO(3),   KC_LCTL, KC_GRV,    KC_LALT,  KC_LGUI,               KC_SPC,   KC_KP_ASTERISK,     KC_KP_1, KC_KP_2,  KC_KP_3, KC_KP_0
    ),
    [2] = LAYOUT_tkl_ansi(
        KC_INS,  MD_BLE1, MD_BLE2,   MD_BLE3,  MD_24G,     RM_NEXT,   TO(1),    TO(0),   KC_LBRC, KC_RBRC,  KC_BSLS,  RM_TOGG,
