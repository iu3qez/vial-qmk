...
/* EEPROM emulata nel journal flash a 2 pagine di user_eeprom.c: ogni record
 * da 4 byte contiene 2 byte di dato, quindi con pagine da 8 KB il massimo
 * teorico è ~4 KB. 2048 byte costano (2048+64+2) = 2114 byte di cache RAM
 * e lasciano ~990 scritture tra una compattazione e l'altra. */
